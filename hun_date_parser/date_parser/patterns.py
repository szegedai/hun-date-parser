...
R_TOLIG_YM = r"((?:\b\d{4}(?!\d)) ?(?:\bjan(?:\b|\.|u[aá]r){1}|\bfeb(?:\b|r\.|\.|ru[aá]r){1}|\bm[aá]r(?:\b|c\b|c\.|\.|cius){1}|\b[aá]pr(?:\b|\.|ilis){1}\b|m[aá]j(?:\b|\.|us){1}|\bj[uú]n(?:\b|\.|ius){1}|\bj[uú]l(?:\b|\.|ius){1}|\baug(?:\b|\.|usztus){1}|\bszept(?:\b|\.|ember){1}|\bokt(?:\b|\.|[oó]ber){1}|\bnov(?:\b|\.|ember){1}|\bdec(?:\b|\.|ember))) ?- ?((?:\b\d{4}(?!\d))? ?(?:\bjan(?:\b|\.|u[aá]r)|\bfeb(?:\b|r\.|\.|ru[aá]r)|\bm[aá]r(?:\b|c\b|c\.|\.|cius)|\b[aá]pr(?:\b|\.|ilis)|\bm[aá]j(?:\b|\.|us)|\bj[uú]n(?:\b|\.|ius)|\bj[uú]l(?:\b|\.|ius)|\baug(?:\b|\.|usztus)|\bszep(?:t\b|t\.|\b|\.|tember)|\bokt(?:\b|\.|[oó]ber)|\bnov(?:\b|\.|ember)|\bdec(?:\b|\.|ember)))"
R_TOLIG_M = r"((?:\bjan(?:\b|\.|u[aá]r){1}|\bfeb(?:\b|r\.|\.|ru[aá]r){1}|\bm[aá]r(?:\b|c\b|c\.|\.|cius){1}|\b[aá]pr(?:\b|\.|ilis){1}\b|m[aá]j(?:\b|\.|us){1}|\bj[uú]n(?:\b|\.|ius){1}|\bj[uú]l(?:\b|\.|ius){1}|\baug(?:\b|\.|usztus){1}|\bszept(?:\b|\.|ember){1}|\bokt(?:\b|\.|[oó]ber){1}|\bnov(?:\b|\.|ember){1}|\bdec(?:\b|\.|ember))) ?-( ?(?:\bjan(?:\b|\.|u[aá]r)|\bfeb(?:\b|r\.|\.|ru[aá]r)|\bm[aá]r(?:\b|c\b|c\.|\.|cius)|\b[aá]pr(?:\b|\.|ilis)|\bm[aá]j(?:\b|\.|us)|\bj[uú]n(?:\b|\.|ius)|\bj[uú]l(?:\b|\.|ius)|\baug(?:\b|\.|usztus)|\bszep(?:t\b|t\.|\b|\.|tember)|\bokt(?:\b|\.|[oó]ber)|\bnov(?:\b|\.|ember)|\bdec(?:\b|\.|ember)))"
...
R_NAMED_MONTH_SME = r"(\b\d{4}(?!\d)|j[oöő]v[oöő].*?|tavaly.*?)? ?(\bjan(?:\b|\.|u[aá]r){1}|\bfeb(?:\b|r\.|\.|ru[aá]r){1}|\bm[aá]r(?:\b|c\b|c\.|\.|cius){1}|\b[aá]pr(?:\b|\.|ilis){1}\b|m[aá]j(?:\b|\.|us){1}|\bj[uú]n(?:\b|\.|ius){1}|\bj[uú]l(?:\b|\.|ius){1}|\baug(?:\b|\.|usztus){1}|\bszept(?:\b|\.|ember){1}|\bokt(?:\b|\.|[oó]ber){1}|\bnov(?:\b|\.|ember){1}|\bdec(?:\b|\.|ember)) (elej|k[oö]zep|v[eé]g)"
